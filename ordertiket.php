...
<body style="
  ...
  function hitungTotalTagihan() {
    var jumlahOrang = parseInt(document.getElementById('jumlahorang').value) || 0;
    var jenisTiket = document.getElementById('jenistiket').value;

    // Lakukan penghitungan sesuai dengan logika Anda
    var hargaTiket = 0; // Atur harga tiket sesuai dengan jenis tiket
    ...
    var totalTagihan = jumlahOrang * hargaTiket;
