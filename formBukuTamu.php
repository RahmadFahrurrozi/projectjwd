...
if (isset($_POST["submit"])) { // ceek/Periksa apakah formulir telah disubmit.
    if (tambah($_POST, $connectdb) > 0) { // Panggil fungsi 'tambah' untuk menambahkan entri buku tamu.
        $massageSuccess[] = "Terimakasih sudah mengisi data tamu!"; // menambahkan pesan sukses jika operasi berhasil.
    } else {
...
<body style="background: rgb(0, 0, 0); background: -moz-linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(0, 62, 109, 1) 100%); background: -webkit-linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(0, 62, 109, 1) 100%); background: linear-gradient(180deg, rgba(0, 0, 0, 1) 0%, rgba(0, 62, 109, 1) 100%); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#000000',endColorstr='#003e6d',GradientType=1);">
